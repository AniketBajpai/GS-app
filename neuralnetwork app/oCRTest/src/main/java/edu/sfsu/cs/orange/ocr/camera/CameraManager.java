...
public final class CameraManager {
  ...
  public synchronized Rect getFramingRect() {
    if (framingRect == null) {
      ...
      //framingRect = new Rect(0,(int)(height*0.375), width, height/4);
    }
    return framingRect;
  }
  ...
  public synchronized void adjustFramingRect(int deltaWidth, int deltaHeight) {
    if (initialized) {
      ...
      //framingRect = new Rect(0,3*newHeight/8, newWidth, newHeight/4);
      framingRectInPreview = null;
    } else {
  ...
  public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data, int width, int height) {
   ...
   // return new PlanarYUVLuminanceSource(data, width, height, 0 , (int)(0.375*height),
     //       width, (int)(height*0.25), reverseImage);
  }
