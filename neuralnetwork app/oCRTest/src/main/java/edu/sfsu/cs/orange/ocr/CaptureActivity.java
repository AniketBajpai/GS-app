...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback,
  ShutterButton.OnShutterButtonListener,SpellCheckerSession.SpellCheckerSessionListener {
  ...
  public static final String DEFAULT_OCR_ENGINE_MODE = "Cube_only";
  ...
  private File getStorageDirectory() {
    ...
    if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
      ...
      try {
        ...
        TTS("External storage is unavailable") ;
  ...
  private void initOcrEngine(File storageRoot, String languageCode, String languageName) {    
    ...
    TTS("Please wait App being Initialised") ;
    if (dialog != null) {
      dialog.dismiss();
    }
    ...
    TTS("Please wait for app to initialise");
    String ocrEngineModeName = getOcrEngineModeName();
    if (ocrEngineModeName.equals("Both")) {
      indeterminateDialog.setMessage("Initializing Cube and Tesseract OCR engines for " + languageName + "...");
      TTS("Please wait while the App is Initialised");
    } else {
      indeterminateDialog.setMessage("Initializing " + "Neural Network" + " app for " + languageName + "...");
      TTS("Please wait while the App is Initialised");
    }
  ...
  String correct(String sentence){
    ...
    for(int i=0;i<words.length;i++){
      word = words[i];
      mScs.getSuggestions(new TextInfo(word),3);
    }

    AlertDialog.Builder alertDialog = new AlertDialog.Builder(this);
    alertDialog.setTitle("Reset...");
    alertDialog.setMessage(""+ result+"12"+sentence);
    alertDialog.show();
  ...
  public void onGetSuggestions(SuggestionsInfo[] results) {
    ...
    /*for (int i = 0; i < results.length; ++i) {
      ...
      for (int j = 0; j < len; ++j) {
        result = result + j + results[i].getSuggestionAt(j) + " ";
      }
    }
    result = result + results[0].getSuggestionAt(0);
    */
    result = result + results[0].getSuggestionAt(0) + " ";
