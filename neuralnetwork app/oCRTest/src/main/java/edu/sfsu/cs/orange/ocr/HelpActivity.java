...
public final class HelpActivity extends Activity {
  ...
  protected void onCreate(Bundle icicle) {
    ...
    //t1.speak("Welcome To Neural Networks App  Instructions  : Touch the screen to get the results Please wait patiently after 1st launch to download data . Please Press the button below for proceeding", TextToSpeech.QUEUE_FLUSH, null);
    ...
    //CaptureActivity p1 = new CaptureActivity() ;
    //p1.TTS("YOYOYO");
    //t1.speak("Welcome To Neural Networks App  Instructions  : Touch the screen to get the results Please wait patiently after 1st launch to download data . Please Press the button below for proceeding", TextToSpeech.QUEUE_FLUSH, null);
  ...
  private final class HelpClient extends WebViewClient {
    ...
    public void onPageFinished(WebView view, String url) {
      ...
      t1.speak("Welcome To Neural Networks App  Instructions.\n  : Touch the screen to get the results.\n Please wait patiently after 1st launch to download data .\n Please Press the button below for proceeding.", TextToSpeech.QUEUE_FLUSH, null);
